...
const storyText = 'It was :insertTemp: fahrenheit outside, so :insertx: went for a walk. When they got to :inserty:, they stared in horror for a few moments, then :insertz:. John Doe saw the whole thing, but was not surprised — :insertx: weighs 300 pounds, and it was a hot day.'
...
function result() {
  ...
  if(document.getElementById("uk").checked) {
    ...
    newStory= newStory.replaceAll('fahrenheit', temperature);
